...
VALUES ('ALM-01', 'Almería', 'España', 'Andalucía', '04001', '+34 950 101010', 'Calle Mayor 15');

-- Ejercicio 02
INSERT INTO empleado (codigo_empleado, nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto)
VALUES (32, 'Carlos', 'Ruiz', 'Maza', '2233', 'cruiz@jardineria.es', 'ALM-01', 1, 'Representante Ventas');

-- Ejercicio 03
INSERT INTO cliente (codigo_cliente, nombre_cliente, nombre_contacto, apellido_contacto, telefono, fax, linea_direccion1, ciudad, pais, codigo_empleado_rep_ventas, limite_credito)
VALUES (39, 'Jardines Almería SL', 'Juan', 'Pérez', '600111222', '950111222', 'Av. del Mediterráneo 5', 'Almería', 'España', 32, 4000.00);

-- Ejercicio 04
INSERT INTO pedido (codigo_pedido, fecha_pedido, fecha_esperada, estado, codigo_cliente)
VALUES (129, '2026-03-20', '2026-03-25', 'Pendiente', 39);

INSERT INTO linea_pedido (codigo_pedido, codigo_producto, cantidad, precio_unidad, numero_linea)
VALUES (129, 'AR-001', 5, 10.00, 1),
       (129, 'AR-002', 3, 20.00, 2);

-- Ejercicio 05
-- No, por la restricción de clave FK en la tabla pedido.
-- UPDATE cliente SET codigo_cliente = 40 WHERE codigo_cliente = 39;

-- Ejercicio 06
-- No, porque tiene pedidos asociados en linea_pedido y pedido.
-- DELETE FROM cliente WHERE codigo_cliente = 39;

-- Ejercicio 07
ALTER TABLE linea_pedido ADD total_linea DECIMAL(15,2);
UPDATE linea_pedido SET total_linea = precio_unidad * cantidad * (1 + 21/100);

-- Ejercicio 08
    BEGIN TRANSACTION;
        INSERT INTO oficina (codigo_oficina, ciudad, pais, region, codigo_postal, telefono, linea_direccion1)
        VALUES ('GR-01', 'Granada', 'España', 'Andalucía', '18001', '+34 958 202020', 'Calle Recogidas 1');

        INSERT INTO empleado (codigo_empleado, nombre, apellido1, extension, email, codigo_oficina, puesto)
        VALUES (33, 'Ana', 'López', '3001', 'alopez@jardineria.es', 'GR-01', 'Representante Ventas'),
               (34, 'Luis', 'Gómez', '3002', 'lgomez@jardineria.es', 'GR-01', 'Representante Ventas'),
               (35, 'Eva', 'Mesa', '3003', 'emesa@jardineria.es', 'GR-01', 'Representante Ventas');
    COMMIT TRANSACTION;

-- Ejercicio 09
INSERT INTO cliente (codigo_cliente, nombre_cliente, telefono, fax, linea_direccion1, ciudad, codigo_empleado_rep_ventas)
VALUES (41, 'Huerta Nazarí', '95811', '95811', 'Calle Elvira', 'Granada', 33),
       (42, 'Flores Albaicín', '95822', '95822', 'Plaza Larga', 'Granada', 34),
       (43, 'Viveros Genil', '95833', '95833', 'Paseo del Salón', 'Granada', 35);
